...
class YouTubeUploader:
	...
	def __init__(self, video_path: str, metadata_json_path: Optional[str] = None,
		...
		gecko_path = r'C:\Users\slega\OneDrive\Desktop\selenium_python\youtube_uploader_selenium\geckodriver.exe'
		self.browser = Firefox(geckodriver_path=gecko_path, profile_path=profile_path, pickle_cookies=True, full_screen=False)
	...
	def __upload(self) -> Tuple[bool, Optional[str]]:
		...
		# 	thumbnail_xpath = Constant.INPUT_FILE_THUMBNAIL
		# 	thumbnail_input = self.browser.find(By.XPATH, thumbnail_xpath)
